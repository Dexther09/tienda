...
<body id="container-page-index">
    ...
    <section id="container-pedido">
        <div class="container">
            <div class="page-header">
                <h1>PEDIDOS <small class="tittles-pages-logo">SmarHome</small></h1>
            </div>
            <br><br><br>
            <div class="row">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-xs-10 col-xs-offset-1">
                                ...
                                <p class="text-center">
                                    <button class="btn btn-lg btn-raised btn-success btn-block" data-toggle="modal"
                                        data-target="#PagoModalTran">Transaccion Bancaria</button>
                                </p>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal fade" id="PagoModalTran" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            ...
            ?>
                    <p>Por favor haga el deposito en la siguiente cuenta de banco e ingrese el numero de deposito que se
                        le proporciono.</p><br>
                    <p>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="NumDepo" placeholder="Numero de deposito"
                    ...
                    <div class="form-group">
                        <label>C.I. del cliente</label>
                        <input class="form-control" type="text" name="Cedclien" placeholder="DNI del cliente"
