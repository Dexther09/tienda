    ...
    <section id="store">
        ...
        <div class="container">
            <div class="page-header">
                <h1>BÚSQUEDA DE PRODUCTOS <small class="tittles-pages-logo">SmarHome</small></h1>
            </div>
                            ...
                            <div class="caption">
                                ...
                                <p class="text-center">
                                    <a href="infoProd.php?CodigoProd=<?php echo $prod['CodigoProd']; ?>"
                                        class="btn btn-primary btn-raised btn-sm btn-block"><i
                                            class="fa fa-plus"></i>&nbsp; Detalles</a>
                                </p>
