...
$pdf->Cell (0,5,utf8_decode('SmartHome'),0,1,'C');
$pdf->Ln(5);
...
$pdf->Ln(12);
$pdf->SetFont("Times","b",12);
$pdf->Cell (30,5,utf8_decode('NIT/C.I.: '),0);
$pdf->SetFont("Times","",12);
...
while($fila1 = mysqli_fetch_array($sDet, MYSQLI_ASSOC)){
    ...
    $pdf->Cell (30,10,utf8_decode('Bs'.$fila1['PrecioProd']),1,0,'C');
    $pdf->Cell (30,10,utf8_decode($fila1['CantidadProductos']),1,0,'C');
    $pdf->Cell (30,10,utf8_decode('Bs'.$fila1['PrecioProd']*$fila1['CantidadProductos']),1,0,'C');
    $pdf->Ln(10);
...
$pdf->Cell (30,10,utf8_decode(''),1,0,'C');
$pdf->Cell (30,10,utf8_decode('BS'.number_format($suma,2)),1,0,'C');
$pdf->Ln(10);
